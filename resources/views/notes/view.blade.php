            ...
            <div class="col-12">
                <div class="card">
                    <div
                        ...
                        <h5 class="card-title mb-sm-0 me-2">View Note</h5>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input class="form-control" value="{{ $note->name }}" type="text" name="note_name"
                                    id="note_name">
                            </div>

                            <div class="mb-12 col-lg-12 col-xl-12 col-12 mb-3">
                                <label class="form-label" for="full-editor">Note</label>
                                <textarea class="form-control summernote" name="note" id="note" rows="4"> {!! $note->note !!}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-11"></div>
                            <div class="col-md-1">
                                <button class="btn btn-primary" id="submitNote" type="submit">Update</button>
                            </div>
                        </div>
                    </div>
                    <hr>
