...
@section('content')
    <div class="row mt-5">
        <div class="col-sm-3">
            <a href="test/create" class="form-control btn btn-info"><i
                    class="menu-icon tf-icons ti ti-clipboard-text"></i>Create Test</a>
        </div>
        <div class="col-sm-3">
            <a href="test/list" class="form-control btn btn-warning"><i
                    class="menu-icon tf-icons ti ti-file-certificate"></i>Tests List</a>
        </div>
        <div class="col-sm-3">
