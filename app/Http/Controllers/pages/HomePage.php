...
class HomePage extends Controller
{
  ...
  public function getGraphDataAjax(){
    ...
    foreach ($books as $book) {
      $test = Test::where([['book_id',$book->id],['created_for',$user_id],['status','Attempted'],['test_type','!=','Self']])->select(DB::raw('sum(total_questions) as total_marks'), DB::raw('sum(obtained_marks) as obtained_marks'))->first();
